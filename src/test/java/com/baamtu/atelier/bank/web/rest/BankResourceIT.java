...
import com.baamtu.atelier.bank.repository.BankRepository;
...
class BankResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "Pw6L5~@eyK.>#+PeO";
    private static final String UPDATED_EMAIL = "~]L-\\@p.e";
    ...
    public static Bank createEntity(EntityManager em) {
        Bank bank = new Bank().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).contact(DEFAULT_CONTACT).email(DEFAULT_EMAIL);
        return bank;
    }
    ...
    public static Bank createUpdatedEntity(EntityManager em) {
        Bank bank = new Bank().name(UPDATED_NAME).address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).email(UPDATED_EMAIL);
        return bank;
    }
    ...
    void createBank() throws Exception {
        ...
        assertThat(testBank.getContact()).isEqualTo(DEFAULT_CONTACT);
    ...
    void putNewBank() throws Exception {
        ...
        updatedBank.name(UPDATED_NAME).address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).email(UPDATED_EMAIL);
        ...
        assertThat(testBank.getContact()).isEqualTo(UPDATED_CONTACT);
    ...
    void partialUpdateBankWithPatch() throws Exception {
        ...
        partialUpdatedBank.contact(UPDATED_CONTACT).email(UPDATED_EMAIL);
    ...
    void fullUpdateBankWithPatch() throws Exception {
        ...
        partialUpdatedBank.name(UPDATED_NAME).address(UPDATED_ADDRESS).contact(UPDATED_CONTACT).email(UPDATED_EMAIL);
