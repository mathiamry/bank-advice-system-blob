...
export class AdvisorComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('jhi-advisor div table .btn-danger'));
  title = element.all(by.css('jhi-advisor div h2#page-heading span')).first();
...
export class AdvisorUpdatePage {
  pageTitle = element(by.id('jhi-advisor-heading'));
...
export class AdvisorDeleteDialog {
  private dialogTitle = element(by.id('jhi-delete-advisor-heading'));
  private confirmButton = element(by.id('jhi-confirm-delete-advisor'));
